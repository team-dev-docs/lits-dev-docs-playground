...
var import_cl100k_base = __toESM(require("tiktoken/encoders/cl100k_base.json"));
...
var GlobalsHelper = class {
  ...
  initDefaultTokenizer() {
    const encoding = new import_lite.Tiktoken(
      import_cl100k_base.default.bpe_ranks,
      import_cl100k_base.default.special_tokens,
      import_cl100k_base.default.pat_str
    );
