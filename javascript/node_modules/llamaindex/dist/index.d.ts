...
declare class HistoryChatEngine {
    ...
    chat<T extends boolean | undefined = undefined, R = T extends true ? AsyncGenerator<string, void, unknown> : Response>(message: string, chatHistory: ChatHistory, streaming?: T): Promise<R>;
    protected streamChat(message: string, chatHistory: ChatHistory): AsyncGenerator<string, void, unknown>;
}
